...
# function to test if is numeric
...
class Question:
	...
	'column value' (i.e., Green). The 'match' method is used to compare
	the feature value in an example to the feature value stored in the 
	question. See demo below.
	'''
...
def build_tree(rows):
	...
	2) start by checking for the base case (no further IG).
